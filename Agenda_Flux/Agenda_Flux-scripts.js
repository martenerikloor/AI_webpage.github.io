...
// Portfolio data for carousel
        ...
        // Skills data
        const skillsData = [
            { name: 'READING COMPREHENSION', icon: '📖', level: 0, category: 'frontend' },
            { name: 'maintaining the agenda', icon: '⌚', level: 100, category: 'backend' },
            { name: 'GLAZING', icon: '💯', level: 100, category: 'frontend' },
            { name: 'SLANDERING', icon: '🗣️', level: 100, category: 'cloud' },
            { name: 'WHAT THE AUTHOR WANTS', icon: '❓', level: 0, category: 'cloud' },
            { name: 'BIAS', icon: '🥶', level: 100, category: 'backend' },
            { name: 'LOGIC', icon: '🧠', level: 0, category: 'cloud' },
            { name: 'IGNORANCE', icon: '🐒', level: 100, category: 'backend' },
            { name: 'FACTS', icon: '💡', level: 0, category: 'emerging' }
        ];
        ...
        function createCarouselItem(data, index) {
            ...
            item.innerHTML = `
                <div class="card">
                    ...
                    <button class="card-cta" onclick="window.location.href='graphs.html'">Detailed Graphs</button>
                </div>
            `;
        ...
        // Form submission (guarded: form may not exist)
